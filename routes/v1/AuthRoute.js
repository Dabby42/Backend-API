...
const {authenticate, register, refreshToken, updateProfile, getBearerToken, getTwitterRequestToken, getTwitterAccessToken, getInstagramAccessToken, getInstagramAuthorizationCode} = new AuthController();
